...
export class SessionController {
    static getAll = async (req: Request, res: Response) => {
        try {
            ...
            if (athleteId) {
                targetAthleteId = parseInt(athleteId as string, 10);
            ...
            if (!targetAthleteId || Number.isNaN(targetAthleteId)) {
            ...
            queryBuilder.where("session.athleteId = :athleteId", { athleteId: targetAthleteId });
            if (programId) {
