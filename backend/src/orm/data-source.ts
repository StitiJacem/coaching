...
export const AppDataSource = new DataSource({
    ...
    synchronize: true,
    logging: false,
    entities: [User, Athlete, Program, Session, Goal, CoachProfile, CoachSpecialization, CoachCertification, ProgramDay, ProgramExercise, WorkoutLog, ExerciseLog, CoachingRequest, UserInvitation, ActivityEvent, Notification, BodyMetric],
    migrations: [],
    subscribers: [],
});
