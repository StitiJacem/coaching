...
export class CompleteProfileComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.profileForm = this.fb.group({
            ...
            equipment: [''],
            bio: [''], // coach
            experience_years: [0], // coach
            specializations: [''], // coach
            workType: ['Online'], // coach
            coachOfferTypes: [[]], // array of selected offer types for coach
            photo_url: ['']
        });
    }
    ...
    async onSubmit() {
        ...
        try {
            ...
            if (this.selectedFile) {
                const uploadRes = await this.socialAuthService.uploadPhoto(this.selectedFile).toPromise();
                if (uploadRes && uploadRes.photoUrl) {
                    payload.photo_url = uploadRes.photoUrl;
                }
            }
