        ...
        <div *ngFor="let req of connectedRequests"
          ...
          <div class="p-8 space-y-6">
            ...
            <div class="pt-4 flex flex-col gap-3">
              <button [routerLink]="['/dashboard/profile-view', 'coach', req.coachProfileId]"
                class="w-full py-4 rounded-xl bg-white text-black font-black uppercase text-[10px] tracking-[0.2em] hover:bg-gosport-orange hover:text-white transition-all active:scale-95 shadow-lg">
                View Reports
              </button>
